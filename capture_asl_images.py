...
def create_capture_session(output_base_dir="custom_dataset", target_count=100):
    """
...
def batch_capture_mode(output_base_dir="custom_dataset", classes=None, images_per_class=50):
    """
